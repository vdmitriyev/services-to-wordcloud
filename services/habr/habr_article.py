...
class BSCrawler():
    ...
    def process_article(self, user_name):
        """
            (obj) -> None
        ...
        def internal_parser(html):
            ...
            comments = soup.findAll('div', attrs={'class':'content html_format'})
            #print comments 
        ...
        result_csv.append(['1', fetched_comments[0]])

        self.data = {}
        self.data['comments'] = result_csv

        print '[i] all article was extracted'
    ...
    dispatcher_dynamic = {
            'http://habrahabr.ru/company/makeitlab/blog/251865/': [process_article, "makeitlab"]
        }

def main():

    csv_file_name = "habr-articles"
